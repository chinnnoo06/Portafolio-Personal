...
export const Contacto = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className={`contenedor-contacto flex flex-col pt-12 pb-12 sm:pt-20 sm:pb-24 gap-6 mx-auto max-w-[1000px] ${isVisible ? 'animate-fadeUp' : 'opacity-0'
        }`}
    >
      ...
      <div className='flex flex-col-reverse md:flex-row gap-10 items-center'>
        <div className='col1 flex flex-col w-full md:w-1/2'>
          {correoEnviado ? (
            <div className='p-6 bg-[#1e1e1e] rounded-2xl shadow-lg border border-[#383838] h-[25rem] sm:h-[27rem] md:h-[29rem] lg:h-[31rem] flex flex-col justify-center items-center animate-fade-in'>
            ...
            <form
              className="p-4 bg-[#1e1e1e] rounded-2xl shadow-lg space-y-5 border border-[#383838]
                        h-[25rem] sm:h-[27rem] md:h-[29rem] lg:h-[31rem]"
            ...
            >
              <div>
                ...
                <input
                  ...
                  id="nombre"
                  name="nombre"
                  className="w-full px-2 py-[6px] sm:py-2 md:py-[8px] lg:py-[10px]
        ...
        <div className='col2 flex flex-col md:w-1/2 gap-4'>
          ...
          <div className=''>
            <p className='text-xs md:text-sm mb-1'><span className='font-semibold text-[#b03a3a]'>Ubicación:</span> Zapopan, Jalisco</p>
            <p className='text-xs md:text-sm  mb-1'><span className='font-semibold text-[#b03a3a]'>Modalidad:</span> Remoto, híbrido o presencial (dependiendo del proyecto)</p>
            <p className='text-xs md:text-sm '><span className='font-semibold text-[#b03a3a]'>Colaboraciones:</span> Freelance, contratos por proyecto, asociaciones tecnológicas</p>
          </div>

          <div className='redes-sociales flex gap-5 pt-2 text-base md:text-xl'>
