...
export const ServicioCard = ({ titulo, descripcion, icono, tecnologias, height = 'h-60' }) => {
  return (
    <div className={`contenedor-dato bg-[#272727] border-t-4 border-[#b03a3a] shadow-md p-4 ${height} rounded flex flex-col`}>
      ...
      <div className='contenido-tecnologias flex flex-wrap gap-2 pt-6'>
